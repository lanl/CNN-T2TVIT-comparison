# TRAINING SCRIPT FOR PVI SINGLE-FIELD T2T-ViT
"""
...
sys.path.insert(0, os.path.abspath('../'))
sys.path.insert(0, os.path.abspath('../../'))
from modules.ViT_modules import T2T_ViT
...
## Inputs
#############################################
descr_str = 'Trains a PVI Single Field T2TViT to estimate PTW strength scale'
parser = argparse.ArgumentParser(prog='PVI Single Field T2TViT Training',
